...
export default function Navbar() {
  ...
  const MobileMenu = () => {
    ...
    return createPortal(
      <>
        {/* Overlay */}
        <div className="fixed inset-0 z-[10000] bg-black/20 backdrop-blur-sm" onClick={() => setMobileMenuOpen(false)} />
        {/* Menu Panel */}
        <div className="fixed inset-0 z-[10001] w-full h-full overflow-y-auto bg-red-800 px-3 sm:px-6 py-4 sm:py-6 sm:max-w-sm md:max-w-md sm:ring-1 sm:ring-gray-900/10">
